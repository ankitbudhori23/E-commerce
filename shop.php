...
?>    
        ...
        <div class="shop-page">
                        ...
                        $result = mysqli_query($con,"SELECT * FROM `products` limit $page1,12");
                        ...
                        <div class="navpage">
                        <?php
                        $pagec=mysqli_query($con,"select * from products");
                        $pageq= mysqli_num_rows($pagec);
                        $pagea= ceil($pageq/12);
                        for($a=1;$a<=$pagea;$a++)
                        {
                        echo "<a class='pagea' href=?page=$a> $a </a>";
                        }
                        ?>
                        </div>
                        <br>
