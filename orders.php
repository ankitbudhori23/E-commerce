...
$sql = "SELECT ID, name, email FROM contact_us";
                ...
                <div class="feedback">
                    <form class="" method="POST">
                        <label for="name">NAME</label><br>
                          <input class="feed-input" type="text" name="name" id="name" required><br><br>
        
                        <label for="Email">EMAIL</label><br>
                          <input class="feed-input" type="email" name="email" id="Email" required><br><br>
        
                        <label for="mobile">MOBILE NO.</label><br>
                          <input class="feed-input" type="number" name="mobile" id="mobile" maxlength="5" required><br><br>
